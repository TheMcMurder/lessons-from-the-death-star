...
- <Appear>Plan the eventual destruction of the Galactic Empire</Appear>
...
![Darth vader saying "You have failed me for the last time."](https://media0.giphy.com/media/3ohuPwtVfPsxaMp0QM/giphy.gif){.mx-auto .h-64}

---

![Stay on target clip from Star Wars A New Hope ](http://puddlesgathering.com/blog/ani-sw_almost_there.gif){.mx-auto .h-64}